            ...
            <div class="hero">
                <div class="tp-banner-container">
                    <div class="tp-banner">
                        <ul>
                            <!-- SLIDE 1 -->
                            <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-thumb="img/backgrounds/bg-home-fullscreen.jpg" data-delay="10000"  data-saveperformance="on" data-title="We Are g-lenz">
                                <img src="<?php echo base_url('assets/img/backgrounds/bg-home-fullscreen.jpg') ?>" alt="slidebg1" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                                    ...
                                    <div class="tp-caption sft"
                                        ...
                                        <h2 class="home-heading op-1">We Are G-Lenz</h2>
                                    </div>
                                    <!-- Home Subheading -->
                                    <div class="tp-caption home-subheading sft "
                                        ...
                                        data-endspeed="300"
                                        style="z-index: 4; max-width: auto; max-height: auto; white-space:normal;">
                                        <div class="op-1">The First Intelligence Surveillance System Company in Indonesia</div>
                                    </div>
                                    <!-- Home Button -->
        ...
        <!-- Start Services Section -->
            ...
            <section id="portfolio" style="position: relative;">
                ...
                <div class="container">
                    ...
                    <div class="col-md-12 text-center">
                        <h3 class="section-title wow fadeInUp">Featured Products.</h3>
                                ...
                                <div class="img">
                                    ...
                                    <div class="overlay">
                                        <ul class="expand">
                                            ...
                                            <li class="cbp-l-caption-desc">by g-lenz Design</li>
                                            <li class="cbp-l-icon"><a href="<?php echo base_url('assets/images/product/1.jpg') ?>" class="cbp-lightbox" data-title="Dashboard<br>by Wunderwelt"><i class="icon-magnifier"></i></a></li>
                                ...
                                <div class="img">
                                    ...
                                    <div class="overlay">
                                        <ul class="expand">
                                            ...
                                            <li class="cbp-l-caption-desc">by g-lenz Design</li>
                                            <li class="cbp-l-icon"><a href="<?php echo base_url('assets/images/product/2.jpg') ?>" class="cbp-lightbox" data-title="Dashboard<br>by Wunderwelt"><i class="icon-magnifier"></i></a></li>
                                ...
                                <div class="img">
                                    ...
                                    <div class="overlay">
                                        <ul class="expand">
                                            ...
                                            <li class="cbp-l-caption-desc">by g-lenz Design</li>
                                            <li class="cbp-l-icon"><a href="<?php echo base_url('assets/images/product/3.jpg') ?>" class="cbp-lightbox" data-title="Dashboard<br>by Wunderwelt"><i class="icon-magnifier"></i></a></li>
                        ...
                        <div class="col-lg-12 wow fadeInUp" style="z-index:3">
                            <div id="quote-slider" class="owl-carousel">
                                <div>
                                    ...
                                    <h4 class="quote-author highlight">g-lenz Team</h4>
                                </div>
                                <div>
                                    <blockquote>
                                        <i class="icon-left ion-quote ion-2x highlight"></i>
            ...
            <section id="price-list" class="parallax-section-6">
                <div class="container">
                    <div class="row wow fadeInUp">
                        ...
                        <div class="col-md-6 col-sm-6 price-list-box">
                            <div class="price-box">
                        ...
                        <div class="col-md-6 col-sm-6 featured price-list-box">
                            <div class="price-box">
                                <div class="price-table">
                    ...
                    <div class="row">
                        ...
                        <div class="clients">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-6 client wow fadeInUp">
                                <a href="#">
                                    <div class="logo-dark">
                                        <img src="<?php echo base_url('template/img/clients/logo-1-dark.png ') ?>" class="img-responsive" alt="client">
                                    </div>
                                    <div class="logo-light">
                                        <img src="<?php echo base_url('template/img/clients/logo-1-light.png') ?>" class="img-responsive" alt="client">
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-6 client wow fadeInUp">
                                <a href="#">
                                    <div class="logo-dark">
                                        <img src="<?php echo base_url('template/img/clients/logo-2-dark.png') ?>" class="img-responsive" alt="client">
                                    </div>
                                    <div class="logo-light">
                                        <img src="<?php echo base_url('template/img/clients/logo-2-light.png') ?>" class="img-responsive" alt="client">
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-6 client wow fadeInUp">
                                <a href="#">
                                    <div class="logo-dark">
                                        <img src="<?php echo base_url('template/img/clients/logo-3-dark.png') ?>" class="img-responsive" alt="client">
                                    </div>
                                    <div class="logo-light">
                                        <img src="<?php echo base_url('template/img/clients/logo-3-light.png') ?>" class="img-responsive" alt="client">
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-6 client wow fadeInUp">
                                <a href="#">
                                    <div class="logo-dark">
                                        <img src="<?php echo base_url('template/img/clients/logo-4-dark.png') ?>" class="img-responsive" alt="client">
                                    </div>
                                    <div class="logo-light">
                                        <img src="<?php echo base_url('template/img/clients/logo-4-light.png') ?>" class="img-responsive" alt="client">
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-6 client wow fadeInUp">
                                <a href="#">
                                    <div class="logo-dark">
                                        <img src="<?php echo base_url('template/img/clients/logo-5-dark.png') ?>" class="img-responsive" alt="client">
                                    </div>
                                    <div class="logo-light">
                                        <img src="<?php echo base_url('template/img/clients/logo-5-light.png') ?>" class="img-responsive" alt="client">
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-6 client wow fadeInUp">
                                <a href="#">
                                    <div class="logo-dark">
                                        <img src="<?php echo base_url('template/img/clients/logo-6-dark.png') ?>" class="img-responsive" alt="client">
                                    </div>
                                    <div class="logo-light">
                                        <img src="<?php echo base_url('template/img/clients/logo-6-light.png') ?>" class="img-responsive" alt="client">
                                    </div>
                                </a>
                            </div>
                            ...
                            <div id="owl-testimonials" class="owl-carousel">
                                ...
                                <div>
                                    <div class="testimonial">
                                        <i class="icon-left ion-quote ion-2x highlight"></i>
                                            <span>
                                                g-lenz is well documented and well coded, but the best of all is the friendly and quick support behind it.<br>g-lenz Design did a great and dedicated job. Thank you for this awesome theme!
                                            </span>
                                        <i class="icon-right ion-quote ion-2x highlight"></i>
                                    </div>
                                    <div class="testimonial-name">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-offset-3 text-center wow fadeInUp">
                            <div id="message"></div>
                            <form method="post" action="http://g-lenz.g-lenzthemes.com/php/contact-form.php" name="contactform" id="contactform">
                                <fieldset>
                    ...
                    <div class="container">
                            ...
                            <div class="col-md-3 col-sm-6 col-footer">
                                <div class="subscription">
                                    ...
                                    <form action="http://g-lenz.g-lenzthemes.com/php/subscribe-mailchimp.php" method="post" id="subscribe-form" role="form">
                            ...
                            <div class="col-md-3 col-sm-6 col-footer">
                                <div class="contact">
                                    ...
                                    <ul class="contact-details">
                                        ...
                                        <li><p><i class="icon ion-android-mail highlight"></i> <a href="g-lenzdesign%40gmail.html">g-lenzdesign@gmail.com</a></p></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <p>© 2015 g-lenz Theme by <a href="index.html" class="logo">g-lenz Design.</a> All Rights Reserved. </p>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <ul id="social-icons">
