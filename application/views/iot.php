...
<div class="instore">
	<div class="iot-top-dash"></div>
	<div class="container">
		<div class="row">
				<div class="col-lg-6" data-aos="fade-right">
					<img class="imgiot" src="<?php echo base_url("assets/image/iot-image.png"); ?>">
				</div>
				<div class="col-lg-6" data-aos="fade-up">
					Teknologi video analitik G-Lenz memberikan solusi dengan menggabungkan teknologi IOT dan analisa video<br>untuk memberikan informasi bisnis intelejen guna meningkatkan kinerja penjualan, operasional dan<br> pemahaman akan kebutuhan konsumen seperti:<br>
					<ul>
						<li>Pelaporan demografis konsumen secara langsung</li>
						<li>Analisa pengunjung, lalu lintas dan tingkat okupansi toko</li>
						<li>Rekomendasi pemasaran produk berdasarkan segementasi pasar</li>
						<li>Pemantauan saran dan layanan pelanggan</li>
					</ul>
				</div>
		</div>
	</div>
