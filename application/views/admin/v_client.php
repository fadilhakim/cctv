...
<div class="content-page">
	...
	<div class="content">
		<div class="container">  
                            ...
                            <div class="card-box">
                                ...
                                <form class="form-horizontal group-border-dashed" enctype="multipart/form-data" action="<?php echo base_url('admin/add/client'); ?>"  method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" name="client_name" required placeholder="Client Name" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group">
            ...
            <!-- end row -->
            <footer class="footer">
                <?php echo date("Y");?> © G-lenz | Go To : <a href="<?php echo base_url('home'); ?>" target="_blank" class="text-muted">www.cctv.co.id</a>
            </footer>
        </div> <!-- container -->
    </div> <!-- content -->
